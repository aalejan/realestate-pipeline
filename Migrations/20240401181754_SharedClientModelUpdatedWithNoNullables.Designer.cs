...
namespace RealEstatePipeline.Migrations
{
    ...
    [Migration("20240401181754_SharedClientModelUpdatedWithNoNullables")]
    partial class SharedClientModelUpdatedWithNoNullables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstatePipeline.Model.Client_Info", b =>
                {
                    ...
                    b.ToTable("RealEstateInquiries");
                });

            modelBuilder.Entity("RealEstatePipeline.Model.SharedClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SharedClients");
                });

            modelBuilder.Entity("RealEstatePipeline.Model.Agent_Info", b =>
                {
                    b.HasBaseType("RealEstatePipeline.Model.ApplicationUser");
            ...
            modelBuilder.Entity("RealEstatePipeline.Model.ClientRegistration", b =>
                {
                    b.HasBaseType("RealEstatePipeline.Model.ApplicationUser");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RealEstatePipeline.Model.ApplicationUser", null)
                        .WithMany()
