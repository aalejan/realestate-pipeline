        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationPreference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    MinimumBudget = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RealEstateInquiries", x => x.InquiryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgentRatings_AspNetUsers_AgentId",
                        column: x => x.AgentId,
